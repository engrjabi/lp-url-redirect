<template>
  <main class="tm-container masonry">
    <div
      class="item tm-bg-white tm-block tm-block-left"
      data-desktop-seq-no="1"
      data-mobile-seq-no="1"
    >
      <p class="tm-hero-text">
        &ldquo;Class aptent taciti sociosqu ad litora torquent per conubia
        nostra, per inceptos himenaeos. Maecenas vel lacinia ipsum, nec
        fermentum diam. Nulla nec gravida odio, eget vestibulum urna.&rdquo;
      </p>
    ...
    <div
      class="item tm-bg-secondary tm-text-white tm-block tm-block-wider tm-block-pad tm-block-left-2"
    ...
    >
      ...
      <div class="tm-text-right">
        <a href="#" class="tm-btn tm-btn-small tm-btn-primary tm-mt"
          >Read More</a
        >
      </div>
    </div>
    ...
    <div
      class="item tm-block-right"
      data-desktop-seq-no="7"
      data-mobile-seq-no="3"
    >
      <div
        class="tm-block-right-inner tm-bg-primary-light tm-text-white tm-block tm-block-wider tm-block-pad"
      >
        <header>
          <h2 class="tm-text-uppercase">Proin Molestie Purus Non</h2>
        </header>
        <p>
    ...
    >
      <div class="tm-form-container tm-block-pad tm-pb-0">
        <header>
          <h2 class="tm-text-uppercase tm-text-gray-light tm-mb">Contact Us</h2>
        </header>
        <form action="index.html" class="tm-contact-form" method="POST">
          ...
          <div class="tm-text-right">
            <button
              type="submit"
              class="tm-btn tm-btn-secondary tm-btn-pad-big"
            >
              Send
            </button>
          </div>
      ...
      <div class="tm-form-section-tag">
        <div
          class="tm-bg-secondary tm-text-white tm-block-pad tm-form-section-tag-inner"
        >
          <header>
...
let callAdjustLayout: number | null | undefined;
...
$(function () {
  if (detectIE()) {
    alert(
      "Please use the latest version of Chrome or Firefox for best browsing experience."
    );
  }
